...
class CVCDataset(Dataset):
    ...
    def save_result_HFC(self, result_list, model_id):
        ...
        color1 = [[58,148,1], [75,185,0], [122,210,71], [85,0,147], [96,0,159], [118,31,169], [141,64,196], [168,163,207], [68,30,178], [79,0,128], [96,62,198], [129,106,208], [215,109,219]]
        color2 = [[58,148,1], [75,185,0], [79,0,128], [141,64,196], [168,163,207], [96,62,198], [215,109,219]]
        color3 = [[58,148,1], [79,0,128]]
        i = 1
        folder_path = os.path.join(self.rst_dir,'%s_%s_cls'%(model_id,self.period))
        if not os.path.exists(folder_path):
            os.makedirs(folder_path)
