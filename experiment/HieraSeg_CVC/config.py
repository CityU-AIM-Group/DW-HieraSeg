...
class Configuration():
	...
	#	self.TRAIN_CKPT = os.path.join(self.ROOT_DIR,'./model/WCE125_lr001_256_256threshold_margin/deeplabv3plus_res101_atrous_WCE_epoch500_all.pth')
		...
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'./model/CVC_MultiFC/model-best-deeplabv3plus_res101_atrous_CVC_epoch324_jac80.553.pth')
		self.TEST_GPUS = 1
