...
class Configuration():
	def __init__(self):
		...
		self.epoch_start = 30
		self.EXP_NAME = 'ISIC_DW_HieraSeg'
		self.EPS = 0.
	...
	#	self.TRAIN_CKPT = os.path.join(self.ROOT_DIR,'./model/WCE125_lr001_256_256threshold_margin/deeplabv3plus_res101_atrous_WCE_epoch500_all.pth')
		...
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'./model/ISIC_DW_HieraSeg/model-best-deeplabv3plus_res101_atrous_ISIC2017_epoch130_jac77.935.pth')
		self.TEST_GPUS = 1
